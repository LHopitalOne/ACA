...
public:
    ...
    void pop_back();
    void pop_front();
    void push_front(const _ValueT& value);
    void push_back(const _ValueT& value);
...
template<typename _ValueT>
void list<_ValueT>::push_front(const _ValueT& value)
{
    Node* newNode = new Node(value);
...
template<typename _ValueT>
void list<_ValueT>::push_back(const _ValueT& value)
{
    Node* newNode = new Node(value);
