...
int main() {
    ...
    v3.push_front(30);
    std::cout << "After push_front(30): Size = " << v3.size() << ", Capacity = " << v3.capacity() << "\n";
    std::cout << "Values: ";
    for (std::size_t i = 0; i < v3.size(); ++i) {
        std::cout << v3[i] << " ";
    }
    ...
    v3.pop_front();
    std::cout << "After pop_front: Size = " << v3.size() << ", Capacity = " << v3.capacity() << "\n";
    std::cout << "Values: ";
    for (std::size_t i = 0; i < v3.size(); ++i) {
        std::cout << v3[i] << " ";
    }
    ...
    v3.insert(2, 40);
    std::cout << "After insert(2, 40): Size = " << v3.size() << ", Capacity = " << v3.capacity() << "\n";
    std::cout << "Values: ";
    for (std::size_t i = 0; i < v3.size(); ++i) {
        std::cout << v3[i] << " ";
    }
